...
public class hdfsGYT {
    ...
    private static final String HDFS = "hdfs://hadoop-master:9000/";
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        String folder = HDFS + "user/hadoop/small2.csv";
        String local = "/home/hadoop/Workspace/LearnHadoop/Recommend/src/main/resources/uid_to_bid.csv";
        String local1 = "/home/hadoop/Workspace/LearnHadoop/Recommend/src/main/resources";
        //判断某个文件夹是否存在
